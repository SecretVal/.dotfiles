...
do
	local __lspServers = {
		...
		},
		{
			["extraOptions"] = {
				["cmd"] = {
					"/nix/store/900gxqx9zssppc8izvh0i3pi8x80cf1s-vscode-langservers-extracted-4.8.0/bin/vscode-json-language-server",
					"--stdio",
				},
			},
			["name"] = "jsonls",
		...
		{ ["name"] = "htmx" },
		{
			["extraOptions"] = {
				["cmd"] = {
					"/nix/store/900gxqx9zssppc8izvh0i3pi8x80cf1s-vscode-langservers-extracted-4.8.0/bin/vscode-html-language-server",
					"--stdio",
				},
			},
			["name"] = "html",
		...
		{ ["name"] = "gopls" },
		{
			["extraOptions"] = {
				["cmd"] = {
					"/nix/store/900gxqx9zssppc8izvh0i3pi8x80cf1s-vscode-langservers-extracted-4.8.0/bin/vscode-css-language-server",
					"--stdio",
				},
			},
			["name"] = "cssls",
...
do
	local __nixvim_binds = {
		...
		{ ["action"] = "<cmd>Neogit<cr>", ["key"] = "<leader>gs", ["mode"] = "" },
		{
			["action"] = function()
				vim.cmd({
					cmd = "FloatermNew",
		...
		{ ["action"] = "<cmd>Oil<cr>", ["key"] = "<leader>pe", ["mode"] = "" },
	}
...
vim.filetype.add({ ["extension"] = { ["ul"] = "u-lang" } })
